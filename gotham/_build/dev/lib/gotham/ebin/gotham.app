{application,gotham,
             [{compile_env,[{gotham,['Elixir.GothamWeb.Gettext'],error},
              ...
              {applications,[kernel,stdlib,elixir,logger,runtime_tools,
                             ...
                             jason,dns_cluster,plug_cowboy,plug,jsx,
                             pbkdf2_elixir,joken]},
              {description,"gotham"},
              {modules,['Elixir.Gotham','Elixir.Gotham.Application',
                        'Elixir.Gotham.AuthTokens',
                        'Elixir.Gotham.AuthTokens.AuthToken',
                        ...
                        'Elixir.GothamWeb','Elixir.GothamWeb.AuthController',
                        'Elixir.GothamWeb.AuthView',
                        'Elixir.GothamWeb.ChangesetJSON',
                        ...
                        'Elixir.GothamWeb.JWTAuthPlug',
                        'Elixir.GothamWeb.JWTToken',
                        'Elixir.GothamWeb.Layouts',
                        ...
                        'Elixir.Jason.Encoder.Gotham.Gestion.User']},
              {registered,[]},
              {vsn,"0.1.0"},
